...
tag_pretraining = 'CzSL_Pre-training-None_Expert-MG'
tag_finetuning  = 'CzSL_Fine-tuning-None_Expert-MG' 
...
for execution in executions : 
    ...
    ratio = imbalance_ratio(labels_LA_vector)
    ...
    classification_performance_SSL_imbalance(images_LA, predictions, labels, ratio, output_folder,
