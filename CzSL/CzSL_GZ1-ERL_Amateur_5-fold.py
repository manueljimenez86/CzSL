...
tag_pretraining = 'CzSL_Pre-training-Amateur_Expert-ERL'
tag_finetuning  = 'CzSL_Fine-tuning-Amateur_Expert-ERL' 
...
for execution in executions : 
    ...
    CNN_pretraining = Convolutional_CNN(image_tuple, n_classes=3, model_weights=AE_weights_filename)
    ...
    CNN_finetuning = Convolutional_CNN(image_tuple, n_classes=3, model_weights=weights_filepath)
