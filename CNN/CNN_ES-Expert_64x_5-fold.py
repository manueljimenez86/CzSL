...
for execution in executions :
    ...
    for test_partition in partitions : 
        ...
        (images_train, labels_train, labels_train_vector, images_test, labels_test,
         labels_test_vector) = data_split_CNN_test(images_array, images_labels, 'ES_EXPERT', 
        ...
        classification_performance_bin(images_train, predictions, labels_test_vector, train_time,
                                    output_folder, trial_name, test_partition)
        
        save_predictions_bin(labels_test, predictions, test_partition, output_folder, trial_name)
